...
let userAnswers = [],
  ...
  ziobroParts = [
    ...
    "Pedale pisowski w dupę jebany!",
  ];

(nameReaction = ["Elegancko", "Troche chujowo", "Niech będzie"]),
  (tokoQuestions = []),
...
function generateUsername() {
  const e = [
    ...
    t = ["entity", "persona", "bastard", "subject", "beast"],
    n = ["69", "88", "420", "666", "997", "1337", "2137"];
  return (
...
recognition.addEventListener("result", (e) => {
  ...
  recognition.addEventListener("nomatch", (e) => {
    (speechyStateProcess.innerHTML = " nie zrozumiał tego seplenienia"),
